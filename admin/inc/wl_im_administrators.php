	...
	<div class="row">
		<div class="card col">
			<div class="card-header">
				...
				<div class="row">
					<div class="col-md-9 col-xs-12">
						<div class="h3 mt-3"><?php esc_html_e( 'Manage Administrators', WL_IM_DOMAIN ); ?></div>
					</div>
			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col">
						<table class="table table-hover table-striped table-bordered" id="administrator-table" aria-describedby=" admin table">
							<thead>
								<tr>
		...
		<div class="modal-content">
			...
			<div class="modal-body pr-4 pl-4">
				<form id="wlim-add-administrator-form">
					...
					<div class="row">
						<div class="col form-group">
							<label for="wlim-administrator-phone" class="col-form-label"><?php esc_html_e( 'Phone', WL_IM_DOMAIN ); ?>:</label>
							<input name="phone" type="text" class="form-control" id="wlim-administrator-phone" placeholder="<?php esc_attr_e( 'Phone', WL_IM_DOMAIN ); ?>">
						</div>
						<div class="col form-group">
							<label for="wlim-administrator-email" class="col-form-label"><?php esc_html_e( 'Email', WL_IM_DOMAIN ); ?>:</label>
							<input name="email" type="text" class="form-control" id="wlim-administrator-email" placeholder="<?php esc_attr_e( 'Email', WL_IM_DOMAIN ); ?>">
						</div>
					</div>
