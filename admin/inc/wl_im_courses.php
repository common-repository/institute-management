	...
	<div class="row">
		<div class="card col">
			<div class="card-header">
				...
				<div class="row">
					<div class="col-md-9 col-xs-12">
						<div class="h3 mt-3"><?php esc_html_e( 'Manage Courses', WL_IM_DOMAIN ); ?></div>
					</div>
			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col">
						<table class="table table-hover table-striped table-bordered" id="course-table" aria-describedby=" course">
							<thead>
								<tr>
			...
			<div class="modal-body pr-4 pl-4">
				<form id="wlim-add-course-form">
					...
					<div class="form-group">
						...
						<input name="fees" type="number" class="form-control" id="wlim-course-fees" placeholder="<?php esc_html_e( "Fees", WL_IM_DOMAIN ); ?>" min="0">
					</div>
