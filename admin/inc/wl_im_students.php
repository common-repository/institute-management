	...
	<div class="row">
		<div class="card col">
			<div class="card-header">
				...
				<div class="row">
					<div class="col-md-9 col-xs-12">
						<div class="h3 mt-3"><?php esc_html_e( 'Manage Students', WL_IM_DOMAIN ); ?></div>
					</div>
			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col">
						<table class="table table-hover table-striped table-bordered" id="student-table" aria-describedby="students">
							<thead>
								<tr>
