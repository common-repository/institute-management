...
class WL_IM_Menu {
	...
	public static function enqueue_custom_assets() {
		/* Enqueue styles */
		wp_enqueue_style('wl-im-style', WL_IM_PLUGIN_URL . '/admin/css/wl-im-style.css', array(), '3.0');
		...
		// wp_localize_script( 'wl-im-ajax-js', 'WL_IM_PLUGIN_URL', array(WL_IM_PLUGIN_URL) );
	}
}
