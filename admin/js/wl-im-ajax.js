jQuery(document).ready(function () {
  ...
  save(
    ...
    "wl-im-add-administrator",
    "#wlim-add-administrator-form",
    "#add-administrator",
    ["#administrator-table"]
  );
  fetch(
    "#update-administrator",
    "wl-im-fetch-administrator",
    "#fetch_administrator"
  );
  save(
    ".update-administrator-submit",
    "wl-im-update-administrator",
    "#wlim-update-administrator-form",
    "#update-administrator",
    ["#administrator-table"]
  );
  ...
  save(
    ".add-enquiry-submit",
    "wl-im-add-enquiry",
    "#wlim-add-enquiry-form",
    "#add-enquiry",
    ["#enquiry-table"]
  );
  fetch("#update-enquiry", "wl-im-fetch-enquiry", "#fetch_enquiry");
  save(
    ".update-enquiry-submit",
    "wl-im-update-enquiry",
    "#wlim-update-enquiry-form",
    "#update-enquiry",
    ["#enquiry-table"]
  );
  remove(
    ".delete-enquiry",
    "delete-enquiry-id",
    "delete-enquiry-security",
    "delete-enquiry",
    "wl-im-delete-enquiry",
    ["#enquiry-table"]
  );
  ...
  save(
    ...
    "wl-im-update-student",
    "#wlim-update-student-form",
    "#update-student",
    ["#student-table"]
  );
  remove(
    ".delete-student",
    "delete-student-id",
    "delete-student-security",
    "delete-student",
    "wl-im-delete-student",
    ["#student-table"]
  );
  ...
  jQuery(document).on("change", "#wlim-student-from_enquiry", function () {
    ...
    if (this.checked) {
      fetchRecords(
        "wl-im-add-student-fetch-enquiries",
        "#wlim-add-student-from-enquiries"
      );
    } else {
  ...
  jQuery(document).on("change", "#wlim-student-course", function () {
    ...
    if (this.value) {
      ...
      fetchRecords(
        "wl-im-add-student-fetch-course-batches",
        "#wlim-add-student-course-batches",
        data
      );
    } else {
  ...
  jQuery(document).on("change", "#wlim-student-course_update", function () {
    ...
    if (this.value) {
      ...
      fetchRecords(
        "wl-im-add-student-fetch-course-update-batches",
        "#wlim-add-student-course-update-batches",
        data
      );
    } else {
  ...
  jQuery(document).on("change", "#wlim-student-enquiry", function () {
    ...
    fetchRecords(
      "wl-im-add-student-fetch-enquiry",
      "#wlim-add-student-form-fields",
      data
    );
  });
  ...
  jQuery(document).on("change", "#wlim-student-course", function () {
    ...
    fetchRecords(
      "wl-im-add-student-fetch-fees-payable",
      "#wlim-add-student-fetch-fees-payable",
      data
    );
  });
  ...
  save(
    ".add-installment-submit",
    "wl-im-add-installment",
    "#wlim-add-installment-form",
    "#add-installment",
    ["#installment-table"]
  );
  fetch("#update-installment", "wl-im-fetch-installment", "#fetch_installment");
  save(
    ".update-installment-submit",
    "wl-im-update-installment",
    "#wlim-update-installment-form",
    "#update-installment",
    ["#installment-table"]
  );
  remove(
    ...
    "delete-installment-security",
    "delete-installment",
    "wl-im-delete-installment",
    ["#installment-table"]
  );
  ...
  jQuery(document).on("change", "#wlim-installment-student", function () {
    ...
    if (this.value) {
      data = "id=" + this.value;
      fetchRecords(
        "wl-im-add-installment-fetch-fees",
        "#wlim_add_installment_fetch_fees",
        data
      );
    }
  });
